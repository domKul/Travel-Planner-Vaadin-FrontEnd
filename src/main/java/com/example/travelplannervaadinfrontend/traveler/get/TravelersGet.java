...
public class TravelersGet extends VerticalLayout {
    ...
    public TravelersGet() {
        ...
        Button showCustomersButton = new Button("Show travelers list");
        showCustomersButton.addClickListener(event -> showTravelers());
        ...
        add(addCustomer, travelerGrid, showCustomersButton,editCustomerButton, deleteCustomerButton, bkButton);
    }
